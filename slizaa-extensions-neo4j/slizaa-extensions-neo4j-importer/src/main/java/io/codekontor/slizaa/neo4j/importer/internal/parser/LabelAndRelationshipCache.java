...
public class LabelAndRelationshipCache {
  ...
  public static Label convert(io.codekontor.slizaa.scanner.spi.parser.model.Label slizaaLabel) {
   ...
   * @return
   */
  public static Label[] convert(io.codekontor.slizaa.scanner.spi.parser.model.Label[] slizaaLabels) {
   ...
   * @return
   */
  public Label getLabel(io.codekontor.slizaa.scanner.spi.parser.model.Label slizaaLabel) {
